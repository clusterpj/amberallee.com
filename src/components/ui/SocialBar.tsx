...
export function SocialBar() {
  return (
    <div className="fixed right-6 top-1/2 transform -translate-y-1/2 flex flex-col gap-5 z-40 bg-black/60 p-4 rounded-t-2xl rounded-b-2xl">
      {/* Facebook Profile */}
      <a
      ...
      >
        <Instagram className="w-7 h-7 text-[#E4405F] group-hover:text-[#d62e4c]" />
        <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-white px-3 py-1 rounded-lg shadow-md
                       text-sm font-medium text-gray-700 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
          Instagram
        </span>
      ...
      >
        <svg 
          viewBox="0 0 24 24" 
          className="w-7 h-7 text-black group-hover:text-gray-800"
          fill="currentColor"
        >
